...
<?php $query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,products.id as c,orde$productId as opid,orde$quantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,orde$paymentMethod as paym,orde$orderDate as odate,orde$id as oid from orders join products on orde$productId=products.id where orde$userId='".$_SESSION['id']."' and orde$paymentMethod is null");
$cnt=1;
...
?>
				<tr>
					...
					<td><a href="pending-orde$php?id=<?php echo $row['oid']; ?> ">Delete</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
